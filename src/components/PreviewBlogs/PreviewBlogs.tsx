  ...
  <main className="preview-blogs">
    <div className="preview-blogs__container">
      <div className="preview-blogs__content">
        <div className="preview-blogs__banner">
          <div className="preview-blogs__image">
            <Image
              layout="fill"
              objectFit="cover"
          ...
          <h1 className="preview-blogs__title">
            <span>
              <b>&quot;</b>Code Chronicles<b>&quot;</b>
            </span>
            <span>Davit Hunanyan - Personal Blog</span>
          </h1>
        </div>
        <h2 className="preview-blogs__subtitle">
      ...
      <div className="preview-blogs__cards">
        {data &&
          data.map(({ id, title, image }) => (
            <Link key={id} href={`/${id}`} className="preview-blogs__card">
